...
macro_rules! c2d {
    ([$b0:literal, $b1:literal], [$a0:literal, $a1:literal], $fs:expr) => {{
        const K: f64 = 2.0 * $fs;
        FilterOrd1 {
            b_0: b0_d!($b0 as f64, $b1 as f64 * 2.0 * PI, $a0 as f64, $a1 as f64 * 2.0 * PI),
            b_1: b1_d!($b0 as f64, $b1 as f64 * 2.0 * PI, $a0 as f64, $a1 as f64 * 2.0 * PI),
            a_1: a1_d!($b0 as f64, $b1 as f64 * 2.0 * PI, $a0 as f64, $a1 as f64 * 2.0 * PI),
            x_1: 0.0,
            y_1: 0.0,
        }
    }};
...
impl FilterOrd1 {
    fn result(&mut self, x_0: f64) -> f64 {
        let y_0 =
            self.b_0 * x_0 + self.b_1 * self.x_1 - self.a_1 * self.y_1;
        self.y_1 = y_0;
        self.x_1 = x_0;
        y_0
    }
...
mod tests {
	...
	($act:expr, $exp:expr) => {
	    assert!(($act - $exp).abs() < EPSILON, "{} != {} with epsilon {}", $act, $exp, EPSILON);
	}
    }
